export default function () {
  (function () {
    var a = "' of type ", k = "SCRIPT", n = "array", p = "function", q = "google.charts.load", t = "hasOwnProperty",
    ...
    H.Jq = function (b, c, d) {
      ...
      for (var e = b.length, f = 0; f < e; f++) {
        var g = b[f];
        if (c.call(d, g, f, b)) return {Uj: f, Gl: g}
      }
      return {Uj: -1, Gl: void 0}
    };
    H.uh = !1;
    H.Zl = !1;
    H.$l = !1;
    ...
    H.Mk(function (b) {
      ...
      c.prototype.fd = function () {
        ...
        var c = this, d = !1;
        return {resolve: b(this.Rk), reject: b(this.Rd)}
      };
      c.prototype.Rk = function (b) {
        if (b === this) this.Rd(new TypeError("A Promise cannot resolve to itself")); else if (b instanceof c) this.jl(b); else {
          a:switch (typeof b) {
            case v:
              var d =
                null != b;
    ...
    I.ss = function (b) {
      var c = I.ia;
      try {
        I.ia = {Sb: "", hd: !1, type: I.Ab.Vc};
        if (I.Ba(b)) var d = b.call(void 0, {}); else if (I.M(b)) I.El() && (b = I.Ll(b)), d = I.vk.call(void 0, b); else throw Error("Invalid module definition");
        var e = I.ia.Sb;
    ...
    I.vr = function (b) {
      if (I.global.execScript) I.global.execScript(b, "JavaScript"); else { // noinspection JSAnnotator
        if (I.global.eval) {
                if (null == I.ic) {
                  try {
    ...
    I.a = {};
    I.a.fa = {Ja: 1, am: 2, ac: 3, pm: 4, Sm: 5, Rm: 6, mo: 7, wm: 8, Sc: 9, Jm: 10, Mh: 11, Zn: 12};
    I.o = {};
    I.o.ma = I.Z;
    I.o.Vb = function (b, c) {
    ...
    I.j.Ib = function (b, c) {
      ...
      for (var d = b.length, e = I.j.fj, f = 0; f < d; f++) if (!e(b[f], c[f])) return !1;
      return !0
    };
    ...
    I.debug.aa.register = function (b) {
      ...
      if (I.debug.aa.Lg) for (var c = I.debug.aa.Pd, d = 0; d < c.length; d++) b(I.bind(c[d].Ml, c[d]))
    };
    ...
    I.f.va = function (b, c) {
      if (c) b = b.replace(I.f.ee, "&amp;").replace(I.f.De, "&lt;").replace(I.f.Ae, "&gt;").replace(I.f.Ke, "&quot;").replace(I.f.Me, "&#39;").replace(I.f.Fe, "&#0;"), I.f.Rc && (b = b.replace(I.f.we, "&#101;")); else {
        if (!I.f.sh.test(b)) return b;
        -1 != b.indexOf("&") && (b = b.replace(I.f.ee, "&amp;"));
        -1 != b.indexOf("<") && (b = b.replace(I.f.De, "&lt;"));
        -1 != b.indexOf(">") && (b = b.replace(I.f.Ae, "&gt;"));
        -1 != b.indexOf('"') && (b = b.replace(I.f.Ke, "&quot;"));
    ...
    var J;
    var K = I.global.document, ba = I.userAgent.Ef();
    ...
    I.h.i.kb = {Vh: "\u202a", Zh: "\u202b", Ie: "\u202c", Wh: "\u200e", $h: "\u200f"};
    I.h.i.R = {Ta: 1, Ua: -1, sa: 0};
    I.h.i.$b = "right";
    I.h.i.Yb = "left";
    ...
    I.b.m.from = I.b.m.va;
    I.b.m.Re = /^[a-zA-Z0-9-]+$/;
    I.b.m.ri = {action: !0, cite: !0, data: !0, formaction: !0, href: !0, manifest: !0, poster: !0, src: !0};
    I.b.m.Yh = {
      APPLET: !0,
      BASE: !0,
      EMBED: !0,
    ...
    I.b.m.wj = function (b, c, d) {
      if (d instanceof I.f.H) d = I.f.H.s(d); else if ("style" == c.toLowerCase()) d = I.b.m.Jj(d); else {
        if (/^on/i.test(c)) throw Error('Attribute "' + c + '" requires goog.string.Const value, "' + d + '" given.');
        if (c.toLowerCase() in I.b.m.ri) if (d instanceof I.b.C) d = I.b.C.s(d); else if (d instanceof I.b.l) d = I.b.l.s(d); else if (I.M(d)) d = I.b.l.Dc(d).ja(); else throw Error('Attribute "' + c + '" on tag "' + b + '" requires goog.html.SafeUrl, goog.string.Const, or string, value "' + d + '" given.');
      }
      d.wa && (d = d.ja());
    ...
    I.a.I = {};
    I.a.I.Bn = {Sl: "afterbegin", Tl: "afterend", hm: "beforebegin", im: "beforeend"};
    I.a.I.Er = function (b, c, d) {
      b.insertAdjacentHTML(c, I.b.m.s(d))
    };
    I.a.I.ii = {MATH: !0, SCRIPT: !0, STYLE: !0, SVG: !0, TEMPLATE: !0};
    ...
    I.a.I.Cl = function (b, c) {
      if (I.a.I.ck()) for (; b.lastChild;) b.removeChild(b.lastChild);
      b.innerHTML = c
    };
    ...
    I.a.rd = function (b) {
      ...
      if (c) {
        ...
        if (!e || !d) return 0;
        b = I.a.dg(b).height;
        if (I.a.Ob(c) && e.scrollHeight) d = e.scrollHeight != b ? e.scrollHeight : e.offsetHeight; else {
          c = e.scrollHeight;
    ...
    I.a.Vd = function (b, c) {
      if ("textContent" in b) b.textContent = c; else if (b.nodeType == I.a.fa.ac) b.data = String(c); else if (b.firstChild && b.firstChild.nodeType == I.a.fa.ac) {
    ...
    I.a.Ne = {SCRIPT: 1, STYLE: 1, HEAD: 1, IFRAME: 1, OBJECT: 1};
    I.a.Zb = {IMG: " ", BR: "\n"};
    I.a.Hd = function (b) {
    ...
    I.a.mc = function (b) {
      if (I.a.gb.re && null !== b && "innerText" in b) b = I.f.Ti(b.innerText); else {
        var c = [];
        I.a.Ad(b, c, !0);
        b = c.join("")
      }
    ...
    I.a.Ad = function (b, c, d) {
      if (!(b.nodeName in I.a.Ne)) if (b.nodeType == I.a.fa.ac) d ? c.push(String(b.nodeValue).replace(/(\r\n|\r|\n)/g, "")) : c.push(b.nodeValue); else if (b.nodeName in I.a.Zb) c.push(I.a.Zb[b.nodeName]); else for (b = b.firstChild; b;) I.a.Ad(b, c, d), b = b.nextSibling
    };
    I.a.Rf = function (b) {
    ...
    I.a.Qf = function (b, c, d) {
      b = [b];
      for (var e = 0, f = null; 0 < b.length && e < c;) if (f = b.pop(), !(f.nodeName in I.a.Ne)) if (f.nodeType == I.a.fa.ac) {
        var g = f.nodeValue.replace(/(\r\n|\r|\n)/g, "").replace(/ +/g, " ");
        e += g.length
      } else if (f.nodeName in I.a.Zb) e += I.a.Zb[f.nodeName].length; else for (g = f.childNodes.length - 1; 0 <= g; g--) b.push(f.childNodes[g]);
    ...
    I.Promise.Da = !1;
    I.Promise.Wa = 0;
    I.Promise.T = {ya: 0, zh: 1, Ka: 2, na: 3};
    ...
    I.Promise.all = function (b) {
      return new I.Promise(function (c, d) {
        ...
        if (e) for (var g = function (b, d) {
          ...
          d(b)
        }, l = 0, m; l < b.length; l++) m = b[l], I.Promise.Bc(m, I.eb(g, l), h); else c(f)
      })
    };
    I.Promise.lp = function (b) {
      return new I.Promise(function (c) {
        ...
        if (d) for (var f = function (b, f, g) {
          d--;
          e[b] = f ? {vj: !0, value: g} : {vj: !1, reason: g};
          0 == d && c(e)
    ...
    I.Promise.Mq = function (b) {
      return new I.Promise(function (c, d) {
        ...
        if (e) for (var g = function (b) {
          ...
          f[b] = c;
          0 == e && d(f)
        }, l = 0, m; l < b.length; l++) m = b[l], I.Promise.Bc(m, g, I.eb(h, l)); else c(void 0)
      })
    };
    ...
    function P(b, c, d, e) {
      if (d == I.Promise.T.na && c.tb && !c.bc) if (0 < I.Promise.Wa) for (; b && b.Jc; b = b.ea) I.global.clearTimeout(b.Jc), b.Jc = 0; else if (0 == I.Promise.Wa) for (; b && b.oc; b = b.ea) b.oc = !1;
      if (c.Xa) c.Xa.ea = null, I.Promise.lg(c, d, e); else try {
...
*/
    ...
    I.D.F.Cc = function (b, c) {
      ...
      var e = I.b.C.s(b), f = I.a.createElement(k), g = {Vg: f, hh: void 0}, h = new I.async.B(I.D.F.Si, g), l = null,
    ...
    I.D.F.Wb = {Uh: 0, TIMEOUT: 1, vi: 2, wi: 3};
    ...
    google.G.J.Ea.load = function (b, c) {
      b = I.b.C.format(b, c);
      var d = I.D.F.Cc(b, {timeout: google.G.J.Ea.gh, attributes: {async: !1, defer: !1}});
    ...
    google.G.J.Ea.rs = function (b) {
      ...
      var c = {timeout: google.G.J.Ea.gh, attributes: {async: !1, defer: !1}}, d = [];
    ...
    google.G.J.U.wk = function (b) {
      var c = google.G.J.U.Ek(b), d = I.f.H.from("https://www.gstatic.com/charts/%{version}/loader.js");
      return google.G.J.Ea.load(d, {version: c.xk}).then(function () {
